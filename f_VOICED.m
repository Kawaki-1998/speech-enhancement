...
% figure;
 ...
 %subplot(4,1,2), plot(voiced,'b.-'); title('voiced=1, unvoiced=0');
% subplot(5,1,3), plot(voiced_msf,'r.-'); title('voiced-msf');
 %subplot(4,1,3), plot(voiced_zc,'r.-'); title('voiced-zc');
 %subplot(4,1,4), plot(voiced_pitch,'r.-'); title('voiced-pitch');
% 
% figure;
% plot(x);