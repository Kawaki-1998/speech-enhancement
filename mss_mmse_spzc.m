function mss_mmse_spzc(filename, outfile)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  MSS-MMSE-SPZC: Minimum mean square error estimator magnitude-squared
%   spectrum of incorporating SNR uncertainty
% 
% Input: 
%
...
%   Example:
%
%   mss_mmse('sp28_babble_snr10.wav','out.wav');
%
%
%   Yang Lu 
...
if nargin<2
   fprintf('Usage: mmse(''[filename]'' ''[outfile]'' \n\n');
   return;
end
